...
DATASETS = ['writing', 'english', 'german', 'pubmed', 'news_jsonl']
...
def load_news_jsonl(cache_dir, filepath):
    """Load pre-paired human/LLM data from JSON or JSONL files
    
    Args:
        cache_dir: Cache directory (unused but kept for interface compatibility)
        filepath: Path to .json or .jsonl file containing paired data
        
    Returns:
        List of dicts with 'human' and 'llm' keys
    """
    import json
